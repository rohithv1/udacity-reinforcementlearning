...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
	    ...
	    #self.epsilon = (self.alpha ** self.t)  #Working best 
    ...
    def build_state(self):
        ...
        #Replacing Nulls if any in the string given in state
        
        def null_check(input_string):
            if input_string is None:
                return 'None'
            else:
                return str(input_string)
        
        state_tuple = (null_check(waypoint),null_check(inputs['light']),null_check(inputs['left']),null_check(inputs['oncoming']))
        state = '_'.join(state_tuple)
	...
	#### ****Modified after the first set of comments.**** ####
        #maxQ = -1000.0
        #for action in self.Q[state]:
        #    #if maxQ < self.Q[state][action]:
        #    maxQ = max(self.Q[state][action],maxQ)
    ...
    def choose_action(self, state):
        ...
        if not self.learning or (self.epsilon > 0.15):
